    ...
    public class DeseedController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeseedDatabase()
        {
            try
            {
                ...
                await _context.Database.ExecuteSqlRawAsync("DELETE FROM CoursesTags");
                ...
                await _context.Database.ExecuteSqlRawAsync("DBCC CHECKIDENT ('Courses', RESEED, 0)");
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { Error = "Deseeding failed", Details = ex.Message });
            }
        }
    }
}